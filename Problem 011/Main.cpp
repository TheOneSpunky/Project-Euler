...
static constexpr auto findLargestProduct(const std::array<std::array<int, 20>, 20>& grid) -> int {
  auto maxProduct { 0 };
...
auto main() -> int {
  ...
  constexpr auto largestProduct { findLargestProduct(grid) };
